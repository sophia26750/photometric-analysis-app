...
def full_calibration_with_subid(image, wcs_image_name, subid_key):
    ...
    radius = round(astro_results["radius"] * 0.8, 1)
...
def magnitudes(csv_file, green_image, red_image, n, RA, DEC):
    ...
    calibration_num = random.sample(range(0, col_length - 1), 10) #col_length - 1), n)
...
num_rows = full_calibration_with_subid("/Users/admin/source/yspa-research-code/fits_files/r_july13-t24-mvn-red_stacked.fits", "wcs_red_solution.fits", )  #/Users/admin/source/yspa-research-code/fits_files/r_july15-home40-mvn-red-all_stacked.fits"
